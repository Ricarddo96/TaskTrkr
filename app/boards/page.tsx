    ...
    <>
      ...
      <BoardsLayout>
        <div className="container mx-auto px-4 md:px-8 lg:px-12 py-10">
          <div className="flex flex-col gap-4 mt-3 mb-6 md:flex-row md:items-center md:justify-between">
            <h1 className="text-2xl md:text-3xl font-semibold text-white">Mis Tableros</h1>
            <AddNewBoard />
          </div>
